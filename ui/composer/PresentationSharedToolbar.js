// PresentationSharedToolbar.js - Shared toolbar for multi-canvas presentation editor
...
import BackgroundControlDropdown from './BackgroundControlDropdown';
...
const PresentationSharedToolbar = memo(({
  ...
  presentationTitle,
  presentationId,
  isOwner = true, // Whether the current user owns this presentation (hides share button for shared viewers)
  onSave,
  onExport,
  onPresent,
  onClose,
...
export default PresentationSharedToolbar;
