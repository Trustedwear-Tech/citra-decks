...
// PresentationStylePicker.js - Component for selecting and customizing presentation styles
...
export const PRESET_STYLES = [
  ...
  },
  {
    id: 'academic',
    name: 'Academic',
    description: 'Scholarly design for educational presentations',
    preview: {
      primary: '#1E40AF',
      secondary: '#047857',
      accent: '#7C2D12',
    },
    slideBackground: '#FFFBF5',
...
export const PresentationStylePicker = ({
  theme,
  selectedStyle,
  onSelectStyle,
  onGenerateAIStyle,
  ...
  const StyleCard = ({ style, isSelected }) => (
    ...
    >
      ...
      <View
        style={[
          styles.miniSlidePreview,
          { backgroundColor: style.slideBackground || '#fff' },
        ]}
      >
        <View
          style={[
        ...
        <View style={styles.aiStyleContainer}>
          <View style={[styles.aiPromptCard, { backgroundColor: theme.surface, borderColor: theme.border }]}>
            ...
            <Text style={[styles.aiPromptDescription, { color: theme.textSecondary }]}>
              Describe the visual style you want for your presentation. Include colors, mood, industry, or any specific aesthetic preferences.
            </Text>
            ...
            <View style={styles.aiPromptExamples}>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                {[
                  ...
                  'Medical presentation, clean and trustworthy',
                  'Educational, friendly and engaging colors',
                  'Dark mode tech presentation',
                ].map((prompt, index) => (
                  <TouchableOpacity
                    key={index}
...
export default PresentationStylePicker;
