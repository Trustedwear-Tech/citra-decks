...
/**
 * useprintableStyles - Style definitions for printables
 * 
 * Provides printable_STYLES as an object keyed by ID for easy lookup.
 * Compatible with TemplateSelector and PAGETemplates.
 */

// printable styles as object keyed by ID
export const printable_STYLES = {
  ...
  creative: {
    id: 'creative',
    name: 'Creative',
    description: 'Bold and colorful for creative printables',
    accentColor: '#7C3AED',
  ...
  warm: {
    id: 'warm',
    name: 'Warm',
    description: 'Warm oranges and ambers for friendly printables',
    accentColor: '#F59E0B',
...
export function getStyleById(styleId) {
  return printable_STYLES[styleId] || printable_STYLES.corporate;
}
...
export function getStyleList() {
  return Object.values(printable_STYLES);
}

export default printable_STYLES;
